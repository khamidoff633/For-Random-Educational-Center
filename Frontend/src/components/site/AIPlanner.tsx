  ...
  return (
    <section id="planner" className="mx-auto w-[92%] max-w-5xl py-24">
      ...
      <Reveal className="mt-12">
        <div className="glass-strong grid gap-8 rounded-3xl p-6 sm:p-8 lg:grid-cols-2">
          <form onSubmit={submit} className="flex flex-col gap-4">
            ...
            <button
              type="submit"
              disabled={loading}
              className="btn-neon mt-2 inline-flex items-center justify-center gap-2 rounded-xl py-3.5 text-sm disabled:opacity-60"
            >
          ...
          <div className="min-h-[16rem] rounded-2xl border border-white/10 bg-black/30 p-5">
            {error && (
            ...
            {!error && !plan && !loading && (
              <div className="flex h-full flex-col items-center justify-center text-center text-slate-500">
                <Sparkles size={36} className="mb-3 text-neon-violet/50" />
