...
export default function Results({
  ...
  // Duration scales with number of cards so speed stays constant
  const cardWidthPx = 256 + 24; // w-64 + gap-6
  const singleSetWidth = results.length * cardWidthPx;
  const durationSec = Math.max(8, singleSetWidth / 100);

  // CSS keyframe percent = 100 / copies
  ...
  return (
    <>
      ...
      <section id="results" className="py-24 overflow-hidden">
        ...
        {/* Marquee Container */}
        <div
          className="relative mt-14 overflow-hidden py-6 px-4"
