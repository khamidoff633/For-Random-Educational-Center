import type { SchoolSettings, Course, Teacher, StudentResultItem } from "../types";
...
export const DEFAULT_SETTINGS: SchoolSettings = {
  ...
  heroBgImage: "https://images.unsplash.com/photo-1523050854058-8df90110c9f1?q=80&w=1600&auto=format&fit=crop",
...
export const DEFAULT_COURSES: Course[] = [
  {
    ...
    category: "English",
    description: "IELTS imtihoniga tezkor va mukammal tayyorgarlik kursi. Har hafta yozma baholash va shaxsiy fikr-mulohaza beriladi.",
    duration: "3 oy",
  ...
  },
  {
    ...
    category: "English",
    description: "Ingliz tilida erkin gapirish va grammatikani chuqur o'zlashtirish uchun mo'ljallangan intensiv amaliy darslar.",
    duration: "6 oy",
  ...
  },
  {
    ...
    category: "IT",
    description: "Noldan boshlab professional dasturchi bo'ling. HTML, CSS, JavaScript va React'ni amaliy loyihalar orqali o'rganing.",
    duration: "8 oy",
...
export const DEFAULT_RESULTS: StudentResultItem[] = [
  {
    id: "sr1",
